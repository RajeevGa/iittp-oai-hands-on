...
sudo -E ./nr-softmodem -O ~/oai_ants_tutorial_2025/ran/conf/gnb.sa.band78.fr1.106PRB.usrpb210.conf --gNBs.[0].min_rxtxtime 6 --rfsim 
```
...
```bash
cd ~/openairinterface5g/cmake_targets/ran_build/build
sudo -E ./nr-uesoftmodem -r 106 --numerology 1 --band 78 -C 3619200000 --rfsim --ssb 516 -O ~/oai_ants_tutorial_2025/ran/conf/nrue.conf
```
...
To run gNB
```
sudo -E ./nr-softmodem -O ~/oai_ants_tutorial_2025/ran/conf/gnb.sa.band78.fr1.51PRB.usrpb210.conf --gNBs.[0].min_rxtxtime 6 --rfsim 
```

To run UE
```
sudo -E ./nr-uesoftmodem -r 51 --numerology 1 --band 78 -C 3609300000 --rfsim --ssb 228 -O ~/oai_ants_tutorial_2025/ran/conf/ue.conf
```
...
```
cd ~/openairinterface5g/cmake_targets/ran_build/build
sudo -E ./nr-softmodem -O ~/oai_ants_tutorial_2025/ran/conf/gnb-cu.sa.f1.conf
```

To start DU:
```
cd ~/openairinterface5g/cmake_targets/ran_build/build
sudo -E ./nr-softmodem --rfsim -O ~/oai_ants_tutorial_2025/ran/conf/gnb-du.sa.band78.106prb.rfsim.conf
```
Run the UE:
```
cd ~/openairinterface5g/cmake_targets/ran_build/build
sudo -E ./nr-uesoftmodem -r 106 --numerology 1 --band 78 -C 3619200000 --rfsim --ssb 516 -O ~/oai_ants_tutorial_2025/ran/conf/ue.conf
```
...
```
cd ~/openairinterface5g/cmake_targets/ran_build/build
sudo -E ./nr-softmodem --rfsim -O ~/oai_ants_tutorial_2025/ran/conf/gnb.sa.band78.106prb.rfsim.conf
```

Make sure the script file multi-ue.sh is executable, if not modify its permissions:
```
chmod +x ~/oai_ants_tutorial_2025/ran/multi-ue.sh
```

To start UE1:
```
cd ~/openairinterface5g/cmake_targets/ran_build/build
sudo ~/oai_ants_tutorial_2025/ran/multi-ue.sh -c1 -e
sudo -E ./nr-uesoftmodem -r 106 --numerology 1 --band 78 -C 3619200000 --rfsim -O ~/oai_ants_tutorial_2025/ran/conf/ue1.conf --rfsimulator.serveraddr 10.201.1.100 # verify serveraddr
```

To start UE2:
```
cd ~/openairinterface5g/cmake_targets/ran_build/build
sudo ~/oai_ants_tutorial_2025/ran/multi-ue.sh -c2 -e
sudo -E ./nr-uesoftmodem -r 106 --numerology 1 --band 78 -C 3619200000 --rfsim -O ~/oai_ants_tutorial_2025/ran/conf/ue2.conf --rfsimulator.serveraddr 10.202.1.100 # verify serveraddr
```
...
```
sudo ~/oai_ants_tutorial_2025/ran/multi-ue.sh -d1 -d2
```
